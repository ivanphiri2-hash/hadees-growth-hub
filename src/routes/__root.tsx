  ...
  head: () => ({
    meta: [
      ...
      { title: "Hadees Trading — Business Solutions, Digital & Education (South Africa)" },
      {
        name: "description",
        content:
          "HADEES TRADING PTY LTD helps South African entrepreneurs register, comply, brand, and modernise through business services, digital solutions, and professional education.",
      },
      ...
      { property: "og:title", content: "Hadees Trading — Business Solutions & Digital" },
      {
        ...
        content:
          "Business registration, compliance, digital solutions, and trading education for South African entrepreneurs.",
      },
